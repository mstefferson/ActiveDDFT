...
try
  ...
  densityDepDr = DensityDepRotDiffClass( ...
  particleObj.nlDr, particleObj.b, systemObj.n1, ...
    systemObj.n2, systemObj.n3, diffObj.D_rot, sqrt(-1) * gridObj.k3 );
  densityDepD = DensityDepIsoDiffClass( ...
    particleObj.nlDiff{1}, particleObj.nlDiff{2},...
    [diffObj.D_pos, diffObj.D_pos, diffObj.D_rot],...
    {1j * gridObj.k1, 1j * gridObj.k2, 1j * gridObj.k3},...
  ...
  if flags.DiagLop == 1
    [denRecObj, rho]  = denEvolverFTDiagOp( ...
      ...
      polarDrive, noise, densityDepDr, densityDepD, flags, lfid);
  else
