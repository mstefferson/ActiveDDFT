...
function [dV] = dVCalc(vFt, diffObj, dv1Flag, dv2Flag, dv3Flag)
%Takes its derivative in k-space, product in real, then back to k-space
% coordinate 1
if dv1Flag == 1
  %ik1 = diffObj.ik1rep3( ind1, ind2, ind3 );
  dVdx1Ft   = diffObj.ik1 .*  vFt; % derivative of v in k space
